        ...
        <aside className="col-lg-3 col-md-4">
          <div className="card p-3 shadow-soft">
            <div className="d-flex align-items-center gap-3">
              ...
              />
              <div>
                <h5 className="mb-1" style={{ color: "var(--violet-dark)" }}>
                  {user?.name || "Candidate"}
                </h5>
            ...
            <div className="d-grid gap-2">
              <a href="/User/applicationWindow" className="btn btn-outline-primary">
                Apply New
              </a>
        ...
        <main className="col-lg-9 col-md-8">
          <div className="card p-4 shadow-soft">
            <div className="d-flex justify-content-between align-items-start">
              <div>
                <h3 style={{ color: "var(--violet-dark)" }}>Dashboard</h3>
                <p className="mb-0 text-muted">Overview of your recent activity</p>
              </div>
            </div>
            ...
            <section className="mt-4">
              ...
              <div className="d-flex gap-2 mt-2">
                <a href="/User/profile" className="btn btn-outline-primary">
                  Edit Profile
                </a>
                <button
